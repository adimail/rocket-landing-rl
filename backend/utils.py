...
def evaluate_landing(state, config):
    ...
    safe_vx = config.get("landing.thresholds.safe.speed_vx") or 20.0
    safe_vy = config.get("landing.thresholds.safe.speed_vy") or 20.0
    safe_angle = config.get("landing.thresholds.safe.angle") or 5.0
