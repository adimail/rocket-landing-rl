...
def get_rl_config():
    return {
        # Position limits
        "min_pos_x": cfg.get("rocket.position_limits.x")[0] or -2000.0,
        "max_pos_x": cfg.get("rocket.position_limits.x")[1] or 2000.0,
        "min_pos_y": cfg.get("rocket.position_limits.y")[0] or 2000.0,
        "max_pos_y": cfg.get("rocket.position_limits.y")[1] or 2300.0,
        # Velocity limits
        "min_vel_x": cfg.get("rocket.velocity_limits.vx")[0] or -30.0,
        "max_vel_x": cfg.get("rocket.velocity_limits.vx")[1] or -10.0,
        "min_vel_y": cfg.get("rocket.velocity_limits.vy")[0] or -250.0,
        "max_vel_y": cfg.get("rocket.velocity_limits.vy")[1] or -230.0,
        # Acceleration limits
        "min_acc_x": cfg.get("rocket.acceleration_limits.ax")[0] or -5.0,
        "max_acc_x": cfg.get("rocket.acceleration_limits.ax")[1] or 5.0,
        "min_acc_y": cfg.get("rocket.acceleration_limits.ay")[0] or -5.0,
        "max_acc_y": cfg.get("rocket.acceleration_limits.ay")[1] or 5.0,
        # Attitude limits
        "min_angle": cfg.get("rocket.attitude_limits.angle")[0] or -15.0,
        "max_angle": cfg.get("rocket.attitude_limits.angle")[1] or 15.0,
        "min_angular_velocity": cfg.get("rocket.attitude_limits.angularVelocity")[0]
        or -7.5,
        "max_angular_velocity": cfg.get("rocket.attitude_limits.angularVelocity")[1]
        or 7.5,
        # Mass limits
        "min_mass": cfg.get("rocket.mass_limits.mass")[0] or 34000.0,
        "max_mass": cfg.get("rocket.mass_limits.mass")[1] or 38000.0,
        "min_fuel_mass": cfg.get("rocket.mass_limits.fuelMass")[0] or 370000.0,
        "max_fuel_mass": cfg.get("rocket.mass_limits.fuelMass")[1] or 410000.0,
    }
